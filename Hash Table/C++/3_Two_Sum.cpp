...
This solution returns the indices of the numbers that sum to obtain target in random order.
...
In each testacse, first line represents the number of testcases.
